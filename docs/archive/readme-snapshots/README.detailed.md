...
| Project website | [lumbarseg.github.io](https://lumbarseg.github.io/) |

---

## Repository Split

This repository now focuses on reproducible research code and experiment documentation. The Astro website source has been moved to a separate local repository at `../lumbarseg.github.io`, following the FastGS-style split between code and project page.

See [REPOSITORY_SPLIT.md](REPOSITORY_SPLIT.md) for the intended ownership of each repository.
